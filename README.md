...
![Version-Badge](https://img.shields.io/badge/Gokarla_VPC_Module-v1.0.0-Green?style=for-the-badge&logo=terraform&logoColor=BLUE&logoWidth=25)   
## Usage
...
module "vpc" {
  ...
  azs             = ["cn-north-1a", "cn-north-1b", "cn-north-1d"]
